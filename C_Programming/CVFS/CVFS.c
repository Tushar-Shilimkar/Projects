...
void InitialiseUAREA()
{
    ...
    printf("CVFS : UAREA gets initalised succesfully\n");
}
...
void InitialiseSuperBlock()
{
    ...
    printf("CVFS : Super Block gets initalised succesfully\n");
}
...
void CreateDILB()
{
    ...
    printf("CVFS : DILB gets created succesfully\n");
}
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            if(strcmp(Command[0],"exit") == 0)
            {
                ...
                printf("Deallocating all resources of CVFS\n");
